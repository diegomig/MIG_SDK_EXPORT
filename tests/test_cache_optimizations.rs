...
use mig_topology_sdk::cache::state_cache::{StateCacheManager, CachedPoolState, CacheValidationResult};
...
fn test_merkle_hash_calculation() {
    ...
    assert_ne!(hash1, hash3, "Different block should produce different hash");
}
