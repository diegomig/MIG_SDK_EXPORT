...
#[async_trait]
impl DexAdapter for TraderJoeAdapter {
    ...
    async fn discover_pools(
        ...
        info!("Discovering new V2 pools for factory {} from block {} to {}", self.factory_address, from_block, to_block);
        let mut attempts = 0;
        loop {
                    ...
                    for log in logs {
                        ...
                        if log.topics.len() >= 3 && log.data.len() >= 32 {
                            ...
                            discovered_pools.push(PoolMeta {
                                ...
                                pool_id: None,
                                fee: Some(300), // Assuming standard 0.3% fee
                                token0,
                                token1,
                                dex: self.name(),
